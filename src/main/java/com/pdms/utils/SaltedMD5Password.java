...
public class SaltedMD5Password {
    ...
    public String getSecurePassword(String passwordToHash) throws Exception {
    ...
    public String defaultPasswordHash() throws Exception{
        return getSecurePassword(defaultPassword);
    }
